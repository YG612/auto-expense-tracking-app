...
/** App-owned adapter for the optional sherpa-onnx A/B engine. */
internal class SherpaOnnxStreamingRecognizerAdapter(
  context: Context,
    ...
    OnlineRecognizer(
      ...
      config =
        OnlineRecognizerConfig(
          ...
          // App-level explicit stop remains authoritative. Provider endpointing
          // must never end or submit a bookkeeping turn.
